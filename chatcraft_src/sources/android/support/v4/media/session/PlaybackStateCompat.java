...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public String toString() {
        return "PlaybackState {state=" + this.f63a + ", position=" + this.f64b + ", buffered position=" + this.c + ", speed=" + this.d + ", updated=" + this.h + ", actions=" + this.e + ", error code=" + this.f + ", error message=" + this.g + ", custom actions=" + this.i + ", active item id=" + this.j + "}";
    }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            TextUtils.writeToParcel(this.f66b, parcel, i);
        ...
        public String toString() {
            return "Action:mName='" + ((Object) this.f66b) + ", mIcon=" + this.c + ", mExtras=" + this.d;
        }
    }
}
