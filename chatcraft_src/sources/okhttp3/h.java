...
public final class h {
    ...
    static final Comparator<String> f5082a = new Comparator<String>() { // from class: okhttp3.h.1
    ...
    private static final Map<String, h> bk = new TreeMap(f5082a);

    /* renamed from: b, reason: collision with root package name */
    public static final h f5083b = a("SSL_RSA_WITH_NULL_MD5", 1);
