...
public final class b {
    ...
    static final Type[] f3962a = new Type[0];

    public static ParameterizedType a(Type type, Type type2, Type... typeArr) {
        return new C0087b(type, type2, typeArr);
    }
    ...
    public static WildcardType b(Type type) {
        ...
        return new c(upperBounds, f3962a);
    }
    ...
    /* JADX WARN: Type inference failed for: r0v8, types: [com.google.gson.b.b$a] */
    public static Type d(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            return new C0087b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        }
    ...
    static Type b(Type type, Class<?> cls, Class<?> cls2) {
        ...
        com.google.gson.b.a.a(cls2.isAssignableFrom(cls));
    ...
    static void h(Type type) {
        com.google.gson.b.a.a(((type instanceof Class) && ((Class) type).isPrimitive()) ? false : true);
    }

    /* compiled from: $Gson$Types.java */
    /* renamed from: com.google.gson.b.b$b, reason: collision with other inner class name */
    private static final class C0087b implements Serializable, ParameterizedType {
        ...
        public C0087b(Type type, Type type2, Type... typeArr) {
            if (type2 instanceof Class) {
            ...
            this.f3965a = type == null ? null : b.d(type);
            this.f3966b = b.d(type2);
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.c) ^ this.f3966b.hashCode()) ^ b.a((Object) this.f3965a);
        }

        public String toString() {
            int length = this.c.length;
            if (length == 0) {
                return b.f(this.f3966b);
            }
            StringBuilder sb = new StringBuilder((length + 1) * 30);
            sb.append(b.f(this.f3966b));
            sb.append("<");
    ...
    private static final class a implements Serializable, GenericArrayType {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f3963a;

        public a(Type type) {
            this.f3963a = b.d(type);
        }
    ...
    private static final class c implements Serializable, WildcardType {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f3969a;

        /* renamed from: b, reason: collision with root package name */
        private final Type f3970b;

        public c(Type[] typeArr, Type[] typeArr2) {
            com.google.gson.b.a.a(typeArr2.length <= 1);
            com.google.gson.b.a.a(typeArr.length == 1);
            if (typeArr2.length == 1) {
                com.google.gson.b.a.a(typeArr2[0]);
                b.h(typeArr2[0]);
                com.google.gson.b.a.a(typeArr[0] == Object.class);
                this.f3970b = b.d(typeArr2[0]);
                this.f3969a = Object.class;
                return;
            }
            com.google.gson.b.a.a(typeArr[0]);
            b.h(typeArr[0]);
            this.f3970b = null;
            this.f3969a = b.d(typeArr[0]);
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f3969a};
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getLowerBounds() {
            return this.f3970b != null ? new Type[]{this.f3970b} : b.f3962a;
        }
        ...
        public int hashCode() {
            return (this.f3970b != null ? this.f3970b.hashCode() + 31 : 1) ^ (this.f3969a.hashCode() + 31);
        }

        public String toString() {
            if (this.f3970b != null) {
                return "? super " + b.f(this.f3970b);
            }
            if (this.f3969a == Object.class) {
                return "?";
            }
            return "? extends " + b.f(this.f3969a);
        }
    }
}
