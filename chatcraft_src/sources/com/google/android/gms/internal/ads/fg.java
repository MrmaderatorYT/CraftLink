...
public abstract class fg extends azg implements ff {
    public static ff a(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        ...
        if (iInterfaceQueryLocalInterface instanceof ff) {
            return (ff) iInterfaceQueryLocalInterface;
        }
        return new fh(iBinder);
    }
