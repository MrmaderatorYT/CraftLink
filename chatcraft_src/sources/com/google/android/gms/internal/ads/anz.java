...
public final class anz {
    ...
    public static ECParameterSpec a(aob aobVar) throws NoSuchAlgorithmException {
        switch (aobVar) {
            case NIST_P256:
            ...
            default:
                String strValueOf = String.valueOf(aobVar);
    ...
    public static ECPublicKey a(aob aobVar, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec eCParameterSpecA = a(aobVar);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        a(eCPoint, eCParameterSpecA.getCurve());
        return (ECPublicKey) aoe.e.a("EC").generatePublic(new ECPublicKeySpec(eCPoint, eCParameterSpecA));
    }

    public static KeyPair a(ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        KeyPairGenerator keyPairGeneratorA = aoe.d.a("EC");
        keyPairGeneratorA.initialize(eCParameterSpec);
        return keyPairGeneratorA.generateKeyPair();
    }

    public static byte[] a(ECPrivateKey eCPrivateKey, ECPoint eCPoint) throws IllegalStateException, GeneralSecurityException {
        ...
        KeyAgreement keyAgreementA = aoe.c.a("ECDH");
