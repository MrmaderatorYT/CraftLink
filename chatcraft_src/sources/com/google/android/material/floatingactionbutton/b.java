...
class b extends com.google.android.material.floatingactionbutton.a {
    ...
    b(j jVar, com.google.android.material.h.b bVar) {
        super(jVar, bVar);
    }
    ...
    void a(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        if (i > 0) {
            ...
            layerDrawable = new LayerDrawable(new Drawable[]{this.i, this.g});
        } else {
            this.i = null;
            layerDrawable = this.g;
        }
        this.h = new RippleDrawable(com.google.android.material.g.a.a(colorStateList2), layerDrawable, null);
        this.j = this.h;
        this.w.a(this.h);
    }
    ...
    void a(float f, float f2, float f3) {
        if (Build.VERSION.SDK_INT == 21) {
            ...
            if (Build.VERSION.SDK_INT >= 22 && Build.VERSION.SDK_INT <= 24) {
                arrayList.add(ObjectAnimator.ofFloat(this.v, (Property<j, Float>) View.TRANSLATION_Z, this.v.getTranslationZ()).setDuration(100L));
            }
            arrayList.add(ObjectAnimator.ofFloat(this.v, (Property<j, Float>) View.TRANSLATION_Z, 0.0f).setDuration(100L));
            animatorSet.playSequentially((Animator[]) arrayList.toArray(new Animator[0]));
            animatorSet.setInterpolator(f3788a);
    ...
    private Animator a(float f, float f2) {
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.play(ObjectAnimator.ofFloat(this.v, "elevation", f).setDuration(0L)).with(ObjectAnimator.ofFloat(this.v, (Property<j, Float>) View.TRANSLATION_Z, f2).setDuration(100L));
        animatorSet.setInterpolator(f3788a);
        return animatorSet;
    }
