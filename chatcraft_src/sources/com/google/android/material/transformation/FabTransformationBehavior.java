...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private final Rect f3888a;

    /* renamed from: b, reason: collision with root package name */
    private final RectF f3889b;
    ...
    private void a(View view, View view2, boolean z, boolean z2, a aVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        aVar.f3898a.b("elevation").a((Animator) objectAnimatorOfFloat);
    ...
    private void a(View view, View view2, boolean z, boolean z2, a aVar, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        float fA = a(view, view2, aVar.f3899b);
        float fB = b(view, view2, aVar.f3899b);
        if (fA == 0.0f || fB == 0.0f) {
            iVarB = aVar.f3898a.b("translationXLinear");
            iVarB2 = aVar.f3898a.b("translationYLinear");
        } else if ((z && fB < 0.0f) || (!z && fB > 0.0f)) {
            iVarB = aVar.f3898a.b("translationXCurveUpwards");
            iVarB2 = aVar.f3898a.b("translationYCurveUpwards");
        } else {
            iVarB = aVar.f3898a.b("translationXCurveDownwards");
            iVarB2 = aVar.f3898a.b("translationYCurveDownwards");
        }
        i iVar = iVarB;
        i iVar2 = iVarB2;
        if (z) {
    ...
    private void b(View view, final View view2, boolean z, boolean z2, a aVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if ((view2 instanceof d) && (view instanceof ImageView)) {
            ...
            if (z) {
                ...
                objectAnimatorOfInt = ObjectAnimator.ofInt(drawable, e.f3709a, 0);
            } else {
                objectAnimatorOfInt = ObjectAnimator.ofInt(drawable, e.f3709a, 255);
            }
            ...
            aVar.f3898a.b("iconFade").a((Animator) objectAnimatorOfInt);
    ...
    private void a(View view, View view2, boolean z, boolean z2, a aVar, float f, float f2, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof d) {
            final d dVar = (d) view2;
            float fC = c(view, view2, aVar.f3899b);
            float fD = d(view, view2, aVar.f3899b);
            ((FloatingActionButton) view).a(this.f3888a);
            float fWidth = this.f3888a.width() / 2.0f;
            i iVarB = aVar.f3898a.b("expansion");
            if (z) {
                if (!z2) {
                    dVar.setRevealInfo(new d.C0083d(fC, fD, fWidth));
                }
                float f3 = z2 ? dVar.getRevealInfo().c : fWidth;
                ...
                animatorA.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.transformation.FabTransformationBehavior.4
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        d.C0083d revealInfo = dVar.getRevealInfo();
                        revealInfo.c = Float.MAX_VALUE;
                        dVar.setRevealInfo(revealInfo);
                    }
                });
                a(view2, iVarB.a(), (int) fC, (int) fD, f3, list);
                iVar = iVarB;
            } else {
                ...
                int i = (int) fC;
                int i2 = (int) fD;
                a(view2, iVarB.a(), i, i2, f4, list);
                iVar = iVarB;
                a(view2, iVarB.a(), iVarB.b(), aVar.f3898a.a(), i, i2, fWidth, list);
    ...
    private void c(View view, View view2, boolean z, boolean z2, a aVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof d) {
            ...
            if (z) {
                ...
                objectAnimatorOfInt = ObjectAnimator.ofInt(dVar, d.c.f3776a, i);
            } else {
                objectAnimatorOfInt = ObjectAnimator.ofInt(dVar, d.c.f3776a, iC);
            }
            objectAnimatorOfInt.setEvaluator(c.a());
            aVar.f3898a.b("color").a((Animator) objectAnimatorOfInt);
            list.add(objectAnimatorOfInt);
        }
    }
    ...
    private void d(View view, View view2, boolean z, boolean z2, a aVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof ViewGroup) {
            if (((view2 instanceof d) && com.google.android.material.c.c.f3771a == 0) || (viewGroupA = a(view2)) == null) {
                return;
            }
            if (z) {
                if (!z2) {
                    com.google.android.material.a.d.f3708a.set(viewGroupA, Float.valueOf(0.0f));
                }
                objectAnimatorOfFloat = ObjectAnimator.ofFloat(viewGroupA, com.google.android.material.a.d.f3708a, 1.0f);
            } else {
                objectAnimatorOfFloat = ObjectAnimator.ofFloat(viewGroupA, com.google.android.material.a.d.f3708a, 0.0f);
            }
            aVar.f3898a.b("contentFade").a((Animator) objectAnimatorOfFloat);
            list.add(objectAnimatorOfFloat);
        }
    }
    ...
    private ViewGroup a(View view) {
        View viewFindViewById = view.findViewById(a.f.mtrl_child_content_container);
    ...
    private int c(View view) {
        ColorStateList colorStateListT = q.t(view);
