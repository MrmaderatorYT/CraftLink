...
public abstract class ExpandableBehavior extends CoordinatorLayout.b<View> {
    ...
    public boolean a(CoordinatorLayout coordinatorLayout, final View view, int i) {
        ...
        if (q.x(view) || (bVarE = e(coordinatorLayout, view)) == null || !a(bVarE.a())) {
            return false;
        }
        this.f3883a = bVarE.a() ? 1 : 2;
        final int i2 = this.f3883a;
        view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: com.google.android.material.transformation.ExpandableBehavior.1
            @Override // android.view.ViewTreeObserver.OnPreDrawListener
            public boolean onPreDraw() {
                view.getViewTreeObserver().removeOnPreDrawListener(this);
                if (ExpandableBehavior.this.f3883a == i2) {
                    ExpandableBehavior.this.a((View) bVarE, view, bVarE.a(), false);
                }
                return false;
            }
        });
    ...
    private boolean a(boolean z) {
        return z ? this.f3883a == 0 || this.f3883a == 2 : this.f3883a == 1;
    }
}
