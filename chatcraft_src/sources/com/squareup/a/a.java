...
final class a {
    ...
    private static final ConcurrentMap<Class<?>, Map<Class<?>, Method>> f4081a = new ConcurrentHashMap();

    /* renamed from: b, reason: collision with root package name */
    private static final ConcurrentMap<Class<?>, Map<Class<?>, Set<Method>>> f4082b = new ConcurrentHashMap();

    private static void a(Class<?> cls, Map<Class<?>, Method> map) throws SecurityException {
        a(cls, map, new HashMap());
    }

    private static void b(Class<?> cls, Map<Class<?>, Set<Method>> map) throws SecurityException {
        a(cls, new HashMap(), map);
    }

    private static void a(Class<?> cls, Map<Class<?>, Method> map, Map<Class<?>, Set<Method>> map2) throws SecurityException {
    ...
    static Map<Class<?>, e> a(Object obj) throws SecurityException {
        Class<?> cls = obj.getClass();
        HashMap map = new HashMap();
        Map<Class<?>, Method> map2 = f4081a.get(cls);
        if (map2 == null) {
            map2 = new HashMap<>();
            a(cls, map2);
        }
        if (!map2.isEmpty()) {
            for (Map.Entry<Class<?>, Method> entry : map2.entrySet()) {
                map.put(entry.getKey(), new e(obj, entry.getValue()));
            }
        }
        return map;
    }

    static Map<Class<?>, Set<d>> b(Object obj) throws SecurityException {
        Class<?> cls = obj.getClass();
        HashMap map = new HashMap();
        Map<Class<?>, Set<Method>> map2 = f4082b.get(cls);
        if (map2 == null) {
            map2 = new HashMap<>();
            b(cls, map2);
        }
