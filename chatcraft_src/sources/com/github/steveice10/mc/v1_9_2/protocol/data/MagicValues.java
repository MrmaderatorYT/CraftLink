package com.github.steveice10.mc.v1_9_2.protocol.data;
...
import com.github.steveice10.mc.v1_9_2.protocol.data.game.entity.attribute.ModifierType;
...
import com.github.steveice10.mc.v1_9_2.protocol.data.game.window.property.AnvilProperty;
import com.github.steveice10.mc.v1_9_2.protocol.data.game.window.property.BrewingStandProperty;
import com.github.steveice10.mc.v1_9_2.protocol.data.game.window.property.EnchantmentTableProperty;
import com.github.steveice10.mc.v1_9_2.protocol.data.game.window.property.FurnaceProperty;
...
public class MagicValues {
    ...
    static {
        ...
        for (BuiltinSound builtinSound : BuiltinSound.values()) {
            register(builtinSound, Integer.valueOf(builtinSound.ordinal()));
            register(builtinSound, builtinSound.name().toLowerCase().replace('_', '.'));
        }
    }

    private static void register(Enum<?> r2, Object obj) {
        if (!values.containsKey(r2)) {
            values.put(r2, new ArrayList());
        }
        values.get(r2).add(obj);
    }

    public static <T> T key(Class<T> cls, Object obj) {
        Iterator<Object> it = values.keySet().iterator();
        while (it.hasNext()) {
            T t = (T) it.next();
            if (cls.isAssignableFrom(t.getClass())) {
                for (Object obj2 : values.get(t)) {
                    if (obj2 == obj || obj2.equals(obj)) {
                        return t;
                    }
                    if (Number.class.isAssignableFrom(obj2.getClass()) && Number.class.isAssignableFrom(obj.getClass()) && ((Number) obj2).doubleValue() == ((Number) obj).doubleValue()) {
                        return t;
                    }
                }
            }
        }
        throw new IllegalArgumentException("Value " + obj + " has no mapping for key class " + cls.getName() + ".");
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static <T> T value(Class<T> cls, Object obj) {
        if (values.containsKey(obj)) {
            Iterator<Object> it = values.get(obj).iterator();
            while (it.hasNext()) {
                T t = (T) it.next();
                if (cls.isAssignableFrom(t.getClass())) {
                    return t;
