package com.github.steveice10.mc.v1_9_2.protocol.packet.ingame.server.window;
...
public class ServerWindowPropertyPacket implements Packet {
    ...
    /* JADX WARN: Incorrect types in method signature: <T:Ljava/lang/Enum<TT;>;:Lcom/github/steveice10/mc/v1_9_2/protocol/data/game/window/property/WindowProperty;>(ITT;I)V */
    ...
    /* JADX WARN: Incorrect return type in method signature: <T:Ljava/lang/Enum<TT;>;:Lcom/github/steveice10/mc/v1_9_2/protocol/data/game/window/property/WindowProperty;>(Ljava/lang/Class<TT;>;)TT; */
