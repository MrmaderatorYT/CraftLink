...
import com.github.steveice10.mc.v1_9_2.protocol.data.game.world.sound.BuiltinSound;
import com.github.steveice10.mc.v1_9_2.protocol.data.game.world.sound.CustomSound;
import com.github.steveice10.mc.v1_9_2.protocol.data.game.world.sound.Sound;
import com.github.steveice10.mc.v1_9_2.protocol.data.game.world.sound.SoundCategory;
...
public class ServerPlaySoundPacket implements Packet {
    ...
    public void write(NetOutput netOutput) {
        ...
        if (this.sound instanceof CustomSound) {
            ...
            name = (String) MagicValues.value(String.class, (BuiltinSound) this.sound);
        }
