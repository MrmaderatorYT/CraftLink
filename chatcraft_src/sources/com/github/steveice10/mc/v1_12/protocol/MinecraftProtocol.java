...
import com.github.steveice10.mc.v1_12.protocol.ingame.client.ingame.client.window.ClientPrepareCraftingGridPacket;
...
public class MinecraftProtocol extends com.github.steveice10.mc.v1_11_2.protocol.MinecraftProtocol {
    ...
    public void initClientGame(Session session) {
        ...
        registerIncoming(48, ServerUnlockRecipesPacket.class);
        registerIncoming(49, ServerEntityDestroyPacket.class);
        registerIncoming(50, ServerEntityRemoveEffectPacket.class);
        registerIncoming(51, ServerResourcePackSendPacket.class);
        registerIncoming(52, ServerRespawnPacket.class);
        registerIncoming(53, ServerEntityHeadLookPacket.class);
        registerIncoming(54, ServerAdvancementTabPacket.class);
        registerIncoming(55, ServerWorldBorderPacket.class);
        registerIncoming(56, ServerSwitchCameraPacket.class);
        registerIncoming(57, ServerPlayerChangeHeldItemPacket.class);
        registerIncoming(58, ServerDisplayScoreboardPacket.class);
        registerIncoming(59, ServerEntityMetadataPacket.class);
        registerIncoming(60, ServerEntityAttachPacket.class);
        registerIncoming(61, ServerEntityVelocityPacket.class);
        registerIncoming(62, ServerEntityEquipmentPacket.class);
        registerIncoming(63, ServerPlayerSetExperiencePacket.class);
        registerIncoming(64, ServerPlayerHealthPacket.class);
        registerIncoming(65, ServerScoreboardObjectivePacket.class);
        registerIncoming(66, ServerEntitySetPassengersPacket.class);
        registerIncoming(67, ServerTeamPacket.class);
        registerIncoming(68, ServerUpdateScorePacket.class);
        registerIncoming(69, ServerSpawnPositionPacket.class);
        registerIncoming(70, ServerUpdateTimePacket.class);
        registerIncoming(71, ServerTitlePacket.class);
        registerIncoming(72, ServerPlayBuiltinSoundPacket.class);
        registerIncoming(73, ServerPlayerListDataPacket.class);
        registerIncoming(74, ServerEntityCollectItemPacket.class);
        registerIncoming(75, ServerEntityTeleportPacket.class);
        registerIncoming(76, ServerAdvancementsPacket.class);
        registerIncoming(77, ServerEntityPropertiesPacket.class);
        registerIncoming(78, ServerEntityEffectPacket.class);
        registerOutgoing(0, ClientTeleportConfirmPacket.class);
        registerOutgoing(1, ClientPrepareCraftingGridPacket.class);
        registerOutgoing(2, ClientTabCompletePacket.class);
        ...
        registerOutgoing(6, ClientConfirmTransactionPacket.class);
        registerOutgoing(7, ClientEnchantItemPacket.class);
        registerOutgoing(8, ClientWindowActionPacket.class);
        registerOutgoing(9, ClientCloseWindowPacket.class);
        registerOutgoing(10, ClientPluginMessagePacket.class);
        registerOutgoing(11, ClientPlayerInteractEntityPacket.class);
        registerOutgoing(12, ClientKeepAlivePacket.class);
        registerOutgoing(13, ClientPlayerMovementPacket.class);
        registerOutgoing(14, ClientPlayerPositionPacket.class);
        registerOutgoing(15, ClientPlayerPositionRotationPacket.class);
        registerOutgoing(16, ClientPlayerRotationPacket.class);
        registerOutgoing(17, ClientVehicleMovePacket.class);
        registerOutgoing(18, ClientSteerBoatPacket.class);
    ...
    public void initServerGame(Session session) {
        ...
        registerIncoming(1, ClientPrepareCraftingGridPacket.class);
        registerIncoming(2, ClientTabCompletePacket.class);
        ...
        registerIncoming(6, ClientConfirmTransactionPacket.class);
        registerIncoming(7, ClientEnchantItemPacket.class);
        registerIncoming(8, ClientWindowActionPacket.class);
        registerIncoming(9, ClientCloseWindowPacket.class);
        registerIncoming(10, ClientPluginMessagePacket.class);
        registerIncoming(11, ClientPlayerInteractEntityPacket.class);
        registerIncoming(12, ClientKeepAlivePacket.class);
        registerIncoming(13, ClientPlayerMovementPacket.class);
        registerIncoming(14, ClientPlayerPositionPacket.class);
        registerIncoming(15, ClientPlayerPositionRotationPacket.class);
        registerIncoming(16, ClientPlayerRotationPacket.class);
        registerIncoming(17, ClientVehicleMovePacket.class);
        registerIncoming(18, ClientSteerBoatPacket.class);
        ...
        registerOutgoing(48, ServerUnlockRecipesPacket.class);
        registerOutgoing(49, ServerEntityDestroyPacket.class);
        registerOutgoing(50, ServerEntityRemoveEffectPacket.class);
        registerOutgoing(51, ServerResourcePackSendPacket.class);
        registerOutgoing(52, ServerRespawnPacket.class);
        registerOutgoing(53, ServerEntityHeadLookPacket.class);
        registerOutgoing(54, ServerAdvancementTabPacket.class);
        registerOutgoing(55, ServerWorldBorderPacket.class);
        registerOutgoing(56, ServerSwitchCameraPacket.class);
        registerOutgoing(57, ServerPlayerChangeHeldItemPacket.class);
        registerOutgoing(58, ServerDisplayScoreboardPacket.class);
        registerOutgoing(59, ServerEntityMetadataPacket.class);
        registerOutgoing(60, ServerEntityAttachPacket.class);
        registerOutgoing(61, ServerEntityVelocityPacket.class);
        registerOutgoing(62, ServerEntityEquipmentPacket.class);
        registerOutgoing(63, ServerPlayerSetExperiencePacket.class);
        registerOutgoing(64, ServerPlayerHealthPacket.class);
        registerOutgoing(65, ServerScoreboardObjectivePacket.class);
        registerOutgoing(66, ServerEntitySetPassengersPacket.class);
        registerOutgoing(67, ServerTeamPacket.class);
        registerOutgoing(68, ServerUpdateScorePacket.class);
        registerOutgoing(69, ServerSpawnPositionPacket.class);
        registerOutgoing(70, ServerUpdateTimePacket.class);
        registerOutgoing(71, ServerTitlePacket.class);
        registerOutgoing(72, ServerPlayBuiltinSoundPacket.class);
        registerOutgoing(73, ServerPlayerListDataPacket.class);
        registerOutgoing(74, ServerEntityCollectItemPacket.class);
        registerOutgoing(75, ServerEntityTeleportPacket.class);
        registerOutgoing(76, ServerAdvancementsPacket.class);
        registerOutgoing(77, ServerEntityPropertiesPacket.class);
        registerOutgoing(78, ServerEntityEffectPacket.class);
    }
