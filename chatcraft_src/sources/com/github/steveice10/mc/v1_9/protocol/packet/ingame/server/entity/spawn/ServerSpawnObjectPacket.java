...
import com.github.steveice10.mc.v1_9.protocol.data.game.entity.type.object.FallingBlockData;
import com.github.steveice10.mc.v1_9.protocol.data.game.entity.type.object.HangingDirection;
import com.github.steveice10.mc.v1_9.protocol.data.game.entity.type.object.MinecartType;
import com.github.steveice10.mc.v1_9.protocol.data.game.entity.type.object.ObjectData;
import com.github.steveice10.mc.v1_9.protocol.data.game.entity.type.object.ObjectType;
import com.github.steveice10.mc.v1_9.protocol.data.game.entity.type.object.ProjectileData;
import com.github.steveice10.mc.v1_9.protocol.data.game.entity.type.object.SplashPotionData;
...
public class ServerSpawnObjectPacket implements Packet {
    ...
    public ServerSpawnObjectPacket(int i, UUID uuid, ObjectType objectType, double d, double d2, double d3, float f, float f2, double d4, double d5, double d6) {
        this(i, uuid, objectType, new ObjectData() { // from class: com.github.steveice10.mc.v1_9.protocol.packet.ingame.server.entity.spawn.ServerSpawnObjectPacket.1
    ...
    public void read(NetInput netInput) {
        ...
        if (i > 0) {
            if (this.type == ObjectType.MINECART) {
                ...
                this.data = new ObjectData() { // from class: com.github.steveice10.mc.v1_9.protocol.packet.ingame.server.entity.spawn.ServerSpawnObjectPacket.2
                };
            }
        }
