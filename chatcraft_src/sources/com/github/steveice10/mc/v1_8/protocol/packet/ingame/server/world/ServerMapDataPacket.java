...
import com.github.steveice10.mc.v1_8.protocol.data.game.values.world.map.MapData;
import com.github.steveice10.mc.v1_8.protocol.data.game.values.world.map.MapPlayer;
...
public class ServerMapDataPacket implements Packet {
    ...
    public ServerMapDataPacket(int i, byte b2, MapPlayer[] mapPlayerArr) {
        this(i, b2, mapPlayerArr, null);
    }

    public ServerMapDataPacket(int i, byte b2, MapPlayer[] mapPlayerArr, MapData mapData) {
        this.mapId = i;
        this.scale = b2;
