package com.github.steveice10.mc.v1_8.protocol.packet.ingame.server.window;
...
public class ServerWindowPropertyPacket implements Packet {
    ...
    /* JADX WARN: Incorrect types in method signature: <T:Ljava/lang/Enum<TT;>;:Lcom/github/steveice10/mc/v1_8/protocol/data/game/values/window/property/WindowProperty;>(ITT;I)V */
    ...
    /* JADX WARN: Incorrect return type in method signature: <T:Ljava/lang/Enum<TT;>;:Lcom/github/steveice10/mc/v1_8/protocol/data/game/values/window/property/WindowProperty;>(Ljava/lang/Class<TT;>;)TT; */
    public Enum getProperty(Class cls) {
        return MagicValues.key(cls, Integer.valueOf(this.value));
    }
