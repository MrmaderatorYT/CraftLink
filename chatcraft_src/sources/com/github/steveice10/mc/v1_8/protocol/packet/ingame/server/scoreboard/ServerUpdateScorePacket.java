...
import com.github.steveice10.mc.v1_8.protocol.data.game.values.scoreboard.ScoreboardAction;
...
public class ServerUpdateScorePacket implements Packet {
    ...
    public void read(NetInput netInput) {
        ...
        this.action = (ScoreboardAction) MagicValues.key(ScoreboardAction.class, Byte.valueOf(netInput.readByte()));
