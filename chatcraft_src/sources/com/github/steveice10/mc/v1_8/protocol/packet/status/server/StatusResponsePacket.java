package com.github.steveice10.mc.v1_8.protocol.packet.status.server;
...
public class StatusResponsePacket implements Packet {
    ...
    public void read(NetInput netInput) {
        ...
        try {
            if (nVar.a("modinfo")) {
                n nVarD = nVar.d("modinfo");
                if (nVarD.a("modList")) {
                    Iterator<l> it = nVarD.c("modList").iterator();
                    while (it.hasNext()) {
                        n nVar2 = (n) it.next();
                        if (nVar2.a("modid")) {
                            if (nVar2.a("version")) {
                                this.info.addForgeMods(new Mod(nVar2.b("modid").c(), nVar2.b("version").c()));
                            } else {
                                this.info.addForgeMods(new Mod(nVar2.b("modid").c(), nVar2.b("version").c()));
                            }
