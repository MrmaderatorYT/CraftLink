...
public class ServerMultiBlockChangePacket implements Packet {
    ...
    public void read(NetInput netInput) {
        ...
        for (int i3 = 0; i3 < this.records.length; i3++) {
            ...
            this.records[i3] = new BlockChangeRecord(new Position((i << 4) + ((s >> 12) & 15), s & 255, (i2 << 4) + ((s >> 8) & 15)), varInt >> 4, varInt & 15);
        }
    }
    ...
    public void write(NetOutput netOutput) {
        ...
        for (BlockChangeRecord blockChangeRecord : this.records) {
            ...
            netOutput.writeVarInt((blockChangeRecord.getData() & 15) | (blockChangeRecord.getId() << 4));
        }
    }
}
