package com.github.steveice10.mc.v1_11.protocol.packet.ingame.server.world;
...
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.BlockValue;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.BlockValueType;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.ChestValue;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.ChestValueType;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.GenericBlockValue;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.GenericBlockValueType;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.MobSpawnerValue;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.MobSpawnerValueType;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.NoteBlockValue;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.NoteBlockValueType;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.PistonValue;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.value.PistonValueType;
...
public class ServerBlockValuePacket implements Packet {
    ...
    public void read(NetInput netInput) {
        ...
        } else if (this.blockId == 54 || this.blockId == ENDER_CHEST || this.blockId == TRAPPED_CHEST || (this.blockId >= SHULKER_BOX_LOWER && this.blockId <= SHULKER_BOX_HIGHER)) {
