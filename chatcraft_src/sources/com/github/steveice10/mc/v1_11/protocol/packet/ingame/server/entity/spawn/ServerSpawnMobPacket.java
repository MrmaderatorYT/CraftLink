...
import com.github.steveice10.mc.v1_10.protocol.data.game.entity.type.MobType;
...
public class ServerSpawnMobPacket implements Packet {
    ...
    public void read(NetInput netInput) {
        ...
        this.type = (MobType) MagicValues.key(MobType.class, Integer.valueOf(netInput.readVarInt()));
