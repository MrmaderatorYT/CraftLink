...
public class ServerStatisticsPacket implements Packet {
    ...
    public ServerStatisticsPacket(Map<String, Integer> map) {
        this.statistics = new HashMap();
        this.statistics = map;
    }
    ...
    public void read(NetInput netInput) {
        ...
        for (int i = 0; i < varInt; i++) {
            this.statistics.put(netInput.readString(), Integer.valueOf(netInput.readVarInt()));
        }
    }
    ...
    public void write(NetOutput netOutput) {
        ...
        for (String str : this.statistics.keySet()) {
            ...
            netOutput.writeVarInt(this.statistics.get(str).intValue());
        }
    }
    ...
    public static class Statistic {
        ...
        public static final String CRAFT_ITEM(int i) {
            return CRAFT_ITEM_BASE + i;
        }

        public static final String BREAK_BLOCK(int i) {
            return BREAK_BLOCK_BASE + i;
        }

        public static final String USE_ITEM(int i) {
            return USE_ITEM_BASE + i;
        }

        public static final String BREAK_ITEM(int i) {
            return BREAK_ITEM_BASE + i;
        }
    }
}
