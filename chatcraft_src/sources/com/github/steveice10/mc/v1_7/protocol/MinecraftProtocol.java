...
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.ClientPluginMessagePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.ClientRequestPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.ClientSettingsPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.ClientTabCompletePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientChangeHeldItemPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerAbilitiesPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerActionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerAnimationPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerDigPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerInteractEntityPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerMovementPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerPlaceBlockPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerPositionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerPositionRotationPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientPlayerRotationPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.player.ClientSteerVehiclePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.window.ClientCloseWindowPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.window.ClientConfirmTransactionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.window.ClientCreativeInventoryActionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.window.ClientEnchantItemPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.window.ClientWindowActionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.client.world.ClientUpdateSignPacket;
...
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.ServerPluginMessagePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.ServerRespawnPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.ServerStatisticsPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.ServerTabCompletePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerAnimationPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerCollectItemPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerDestroyEntitiesPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityAttachPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityEffectPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityEquipmentPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityHeadLookPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityMetadataPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityMovementPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityPositionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityPositionRotationPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityPropertiesPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityRemoveEffectPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityRotationPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityStatusPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityTeleportPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.ServerEntityVelocityPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.player.ServerChangeHeldItemPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.player.ServerPlayerAbilitiesPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.player.ServerPlayerPositionRotationPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.player.ServerPlayerUseBedPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.player.ServerSetExperiencePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.player.ServerUpdateHealthPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.spawn.ServerSpawnExpOrbPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.spawn.ServerSpawnGlobalEntityPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.spawn.ServerSpawnMobPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.spawn.ServerSpawnObjectPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.spawn.ServerSpawnPaintingPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.entity.spawn.ServerSpawnPlayerPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.scoreboard.ServerDisplayScoreboardPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.scoreboard.ServerScoreboardObjectivePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.scoreboard.ServerTeamPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.scoreboard.ServerUpdateScorePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.window.ServerCloseWindowPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.window.ServerConfirmTransactionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.window.ServerOpenWindowPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.window.ServerSetSlotPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.window.ServerWindowItemsPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.window.ServerWindowPropertyPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerBlockBreakAnimPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerBlockChangePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerBlockValuePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerExplosionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerMapDataPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerMultiBlockChangePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerMultiChunkDataPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerNotifyClientPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerOpenTileEntityEditorPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerPlayEffectPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerPlaySoundPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerSpawnParticlePacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerSpawnPositionPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerUpdateSignPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerUpdateTileEntityPacket;
import com.github.steveice10.mc.v1_7.protocol.packet.ingame.server.world.ServerUpdateTimePacket;
...
public class MinecraftProtocol extends MinecraftPacketProtocol {
    ...
    protected void setMode(ProtocolMode protocolMode, boolean z, Session session) {
        clearPackets();
        switch (protocolMode) {
            case HANDSHAKE:
                if (z) {
