package com.github.steveice10.mc.v1_7.protocol.packet.status.server;
...
import com.github.steveice10.mc.v1_7.protocol.data.message.Message;
import com.github.steveice10.mc.v1_7.protocol.data.status.PlayerInfo;
import com.github.steveice10.mc.v1_7.protocol.data.status.ServerStatusInfo;
import com.github.steveice10.mc.v1_7.protocol.data.status.VersionInfo;
        ...
        if (nVarL2.a("sample")) {
            ...
            if (iVarM.a() > 0) {
                ...
                for (int i = 0; i < iVarM.a(); i++) {
                    ...
                    gameProfileArr[i] = new GameProfile(UUIDSerializer.fromString(nVarL3.b("id").c()), nVarL3.b("name").c());
                }
            }
        }
    ...
    public void write(NetOutput netOutput) {
        ...
        if (this.info.getPlayerInfo().getPlayers().length > 0) {
            ...
            for (GameProfile gameProfile : this.info.getPlayerInfo().getPlayers()) {
                ...
                nVar4.a("id", UUIDSerializer.fromUUID(gameProfile.getId()));
                iVar.a(nVar4);
            }
            nVar3.a("sample", iVar);
        }
