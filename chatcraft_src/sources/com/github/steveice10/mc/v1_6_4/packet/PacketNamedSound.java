...
public class PacketNamedSound extends Packet {
    ...
    public PacketNamedSound(String str, int i, int i2, int i3, float f, int i4) {
        this.sound = str;
        this.x = i;
        this.y = i2;
        this.z = i3;
