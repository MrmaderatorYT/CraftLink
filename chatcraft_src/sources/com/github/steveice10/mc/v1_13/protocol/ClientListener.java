...
import com.github.steveice10.mc.v1_10.protocol.data.handshake.HandshakeIntent;
import com.github.steveice10.mc.v1_10.protocol.data.status.ServerStatusInfo;
import com.github.steveice10.mc.v1_10.protocol.data.status.handler.ServerInfoHandler;
import com.github.steveice10.mc.v1_10.protocol.data.status.handler.ServerPingTimeHandler;
...
import com.github.steveice10.mc.v1_10.protocol.packet.ingame.server.ServerSetCompressionPacket;
...
public class ClientListener extends SessionAdapter {
    ...
    public void connected(ConnectedEvent connectedEvent) {
        ...
        if (minecraftProtocol.getSubProtocol() == SubProtocol.LOGIN) {
            ...
            connectedEvent.getSession().send(new HandshakePacket(MinecraftConstants.PROTOCOL_VERSION, connectedEvent.getSession().getHost(), connectedEvent.getSession().getPort(), HandshakeIntent.LOGIN));
        ...
        if (minecraftProtocol.getSubProtocol() == SubProtocol.STATUS) {
            minecraftProtocol.setSubProtocol(SubProtocol.HANDSHAKE, true, connectedEvent.getSession());
            connectedEvent.getSession().send(new HandshakePacket(MinecraftConstants.PROTOCOL_VERSION, connectedEvent.getSession().getHost(), connectedEvent.getSession().getPort(), HandshakeIntent.STATUS));
