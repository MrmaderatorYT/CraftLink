...
import com.github.steveice10.mc.v1_10.protocol.packet.handshake.client.HandshakePacket;
...
import com.github.steveice10.mc.v1_10.protocol.packet.ingame.client.player.ClientPlayerPlaceBlockPacket;
...
import com.github.steveice10.mc.v1_10.protocol.packet.ingame.server.ServerTitlePacket;
...
import com.github.steveice10.mc.v1_10.protocol.packet.ingame.server.entity.ServerEntityCollectItemPacket;
...
import com.github.steveice10.mc.v1_10.protocol.packet.ingame.server.entity.spawn.ServerSpawnMobPacket;
import com.github.steveice10.mc.v1_10.protocol.packet.ingame.server.entity.spawn.ServerSpawnObjectPacket;
...
import com.github.steveice10.mc.v1_10.protocol.packet.ingame.server.world.ServerBlockValuePacket;
...
public class MinecraftProtocol extends MinecraftPacketProtocol {
    ...
    protected void initServerHandshake(Session session) {
    ...
    protected void initServerLogin(Session session) {
    ...
    protected void initServerGame(Session session) {
    ...
    protected void initServerStatus(Session session) {
