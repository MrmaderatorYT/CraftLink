...
public class ServerSpawnObjectPacket implements Packet {
    ...
    public ServerSpawnObjectPacket(int i, UUID uuid, ObjectType objectType, double d, double d2, double d3, float f, float f2, double d4, double d5, double d6) {
        this(i, uuid, objectType, new ObjectData() { // from class: com.github.steveice10.mc.v1_10.protocol.packet.ingame.server.entity.spawn.ServerSpawnObjectPacket.1
    ...
    public void read(NetInput netInput) {
        ...
        if (i > 0) {
            if (this.type == ObjectType.MINECART) {
                ...
                this.data = new ObjectData() { // from class: com.github.steveice10.mc.v1_10.protocol.packet.ingame.server.entity.spawn.ServerSpawnObjectPacket.2
                };
            }
        }
