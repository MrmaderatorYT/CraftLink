package com.github.steveice10.mc.v1_10.protocol.data;
...
import com.github.steveice10.mc.v1_10.protocol.data.game.entity.attribute.ModifierType;
...
import com.github.steveice10.mc.v1_10.protocol.data.game.window.property.AnvilProperty;
import com.github.steveice10.mc.v1_10.protocol.data.game.window.property.BrewingStandProperty;
import com.github.steveice10.mc.v1_10.protocol.data.game.window.property.EnchantmentTableProperty;
import com.github.steveice10.mc.v1_10.protocol.data.game.window.property.FurnaceProperty;
...
public class MagicValues {
    ...
    static {
        ...
        register(NameTagVisibility.ALWAYS, BuildConfig.FLAVOR);
        ...
        register(CollisionRule.ALWAYS, BuildConfig.FLAVOR);
        ...
        for (BuiltinSound builtinSound : BuiltinSound.values()) {
            ...
            register(builtinSound, builtinSound.name().toLowerCase().replace('_', '.').replace("enchantment.table", "enchantment_table").replace("polar.bear", "polar_bear").replace("wither.skeleton", "wither_skeleton"));
        }
    }
