...
import com.github.steveice10.mc.v1_10.protocol.data.game.statistic.Achievement;
import com.github.steveice10.mc.v1_10.protocol.data.game.statistic.BreakBlockStatistic;
import com.github.steveice10.mc.v1_10.protocol.data.game.statistic.BreakItemStatistic;
import com.github.steveice10.mc.v1_10.protocol.data.game.statistic.CraftItemStatistic;
import com.github.steveice10.mc.v1_10.protocol.data.game.statistic.CustomStatistic;
import com.github.steveice10.mc.v1_10.protocol.data.game.statistic.GenericStatistic;
import com.github.steveice10.mc.v1_10.protocol.data.game.statistic.Statistic;
import com.github.steveice10.mc.v1_10.protocol.data.game.statistic.UseItemStatistic;
    ...
    public void read(NetInput netInput) {
        ...
        for (int i = 0; i < varInt; i++) {
            ...
            if (string.startsWith("achievement.")) {
                customStatistic = (Statistic) MagicValues.key(Achievement.class, string);
            } else if (string.startsWith(CRAFT_ITEM_PREFIX)) {
                customStatistic = new CraftItemStatistic(Integer.parseInt(string.substring(string.lastIndexOf(".") + 1)));
            } else if (string.startsWith(BREAK_BLOCK_PREFIX)) {
                customStatistic = new BreakBlockStatistic(Integer.parseInt(string.substring(string.lastIndexOf(".") + 1)));
            } else if (string.startsWith(USE_ITEM_PREFIX)) {
                customStatistic = new UseItemStatistic(Integer.parseInt(string.substring(string.lastIndexOf(".") + 1)));
            } else if (string.startsWith(BREAK_ITEM_PREFIX)) {
                customStatistic = new BreakItemStatistic(Integer.parseInt(string.substring(string.lastIndexOf(".") + 1)));
            } else {
                try {
                    customStatistic = (Statistic) MagicValues.key(GenericStatistic.class, string);
                } catch (IllegalArgumentException unused) {
                    customStatistic = new CustomStatistic(string);
                }
            }
