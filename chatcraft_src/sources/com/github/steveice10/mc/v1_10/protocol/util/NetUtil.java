package com.github.steveice10.mc.v1_10.protocol.util;

import com.github.steveice10.mc.v1_10.protocol.data.MagicValues;
import com.github.steveice10.mc.v1_10.protocol.data.game.chunk.BlockStorage;
import com.github.steveice10.mc.v1_10.protocol.data.game.chunk.Chunk;
import com.github.steveice10.mc.v1_10.protocol.data.game.chunk.Column;
import com.github.steveice10.mc.v1_10.protocol.data.game.chunk.NibbleArray3d;
...
import com.github.steveice10.mc.v1_10.protocol.data.game.entity.metadata.MetadataType;
import com.github.steveice10.mc.v1_10.protocol.data.game.entity.metadata.Position;
import com.github.steveice10.mc.v1_10.protocol.data.game.entity.metadata.Rotation;
import com.github.steveice10.mc.v1_10.protocol.data.game.world.block.BlockFace;
...
public class NetUtil {
        ...
        for (EntityMetadata entityMetadata : entityMetadataArr) {
            ...
            switch (entityMetadata.getType()) {
                ...
                case BLOCK_STATE:
                    ...
                    break;
                case NBT_TAG:
                    writeNBT(netOutput, (CompoundTag) entityMetadata.getValue());
                    break;
                default:
    ...
    public static Column readColumn(byte[] bArr, int i, int i2, boolean z, boolean z2, int i3, CompoundTag[] compoundTagArr) throws IOException {
        ...
        try {
            ...
            column = new Column(i, i2, chunkArr, z ? streamNetInput.readBytes(256) : null, compoundTagArr);
            e = null;
        } catch (Exception e) {
            e = e;
        }
        if ((streamNetInput.available() > 0 || e != null) && !z2) {
            return readColumn(bArr, i, i2, z, true, i3, compoundTagArr);
        }
        if (e == null) {
            return column;
        }
