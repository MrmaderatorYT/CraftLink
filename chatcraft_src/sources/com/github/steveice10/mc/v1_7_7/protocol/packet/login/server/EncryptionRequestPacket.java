package com.github.steveice10.mc.v1_7_7.protocol.packet.login.server;
...
public class EncryptionRequestPacket implements Packet {
    ...
    public void read(NetInput netInput) {
        ...
        this.publicKey = CryptUtil.decodePublicKey(netInput.readPrefixedBytes());
    ...
    public void write(NetOutput netOutput) {
        ...
        netOutput.writePrefixedBytes(this.publicKey.getEncoded());
