...
import com.github.steveice10.mc.v1_7_7.protocol.data.status.ServerStatusInfo;
import com.github.steveice10.mc.v1_7_7.protocol.data.status.handler.ServerInfoHandler;
import com.github.steveice10.mc.v1_7_7.protocol.data.status.handler.ServerPingTimeHandler;
...
import com.github.steveice10.mc.v1_7_7.protocol.util.CryptUtil;
...
public class ClientListener extends SessionAdapter {
    ...
    public void connected(ConnectedEvent connectedEvent) {
        ...
        if (minecraftProtocol.getMode() == ProtocolMode.LOGIN) {
            ...
            connectedEvent.getSession().send(new HandshakePacket(5, connectedEvent.getSession().getHost(), connectedEvent.getSession().getPort(), 2));
        ...
        if (minecraftProtocol.getMode() == ProtocolMode.STATUS) {
            minecraftProtocol.setMode(ProtocolMode.HANDSHAKE, true, connectedEvent.getSession());
            connectedEvent.getSession().send(new HandshakePacket(5, connectedEvent.getSession().getHost(), connectedEvent.getSession().getPort(), 1));
