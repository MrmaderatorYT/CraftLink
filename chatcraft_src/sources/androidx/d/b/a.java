...
public class a {
    private static final Interpolator v = new Interpolator() { // from class: androidx.d.b.a.1
    ...
    private final AbstractC0044a r;
    private View s;
    private boolean t;
    private final ViewGroup u;
    private int c = -1;
    private final Runnable w = new Runnable() { // from class: androidx.d.b.a.2
    ...
    public static a a(ViewGroup viewGroup, AbstractC0044a abstractC0044a) {
        return new a(viewGroup.getContext(), viewGroup, abstractC0044a);
    }

    public static a a(ViewGroup viewGroup, float f, AbstractC0044a abstractC0044a) {
        a aVarA = a(viewGroup, abstractC0044a);
        aVarA.f690b = (int) (aVarA.f690b * (1.0f / f));
        return aVarA;
    }

    private a(Context context, ViewGroup viewGroup, AbstractC0044a abstractC0044a) {
        if (viewGroup == null) {
        ...
        this.u = viewGroup;
        this.r = abstractC0044a;
        ViewConfiguration viewConfiguration = ViewConfiguration.get(context);
        this.o = (int) ((context.getResources().getDisplayMetrics().density * 20.0f) + 0.5f);
        this.f690b = viewConfiguration.getScaledTouchSlop();
    ...
    public boolean a(View view, int i, int i2) {
        ...
        if (!zA && this.f689a == 0 && this.s != null) {
            this.s = null;
        }
        return zA;
    }
    ...
    */
    public boolean a(android.view.MotionEvent r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.d.b.a.a(android.view.MotionEvent):boolean");
    }
    ...
    public void b(MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case 6:
                ...
                if (this.f689a == 1 && pointerId4 == this.c) {
    ...
    private boolean a(float f, float f2, int i, int i2) {
        ...
        if ((this.h[i] & i2) != i2 || (this.p & i2) == 0 || (this.j[i] & i2) == i2 || (this.i[i] & i2) == i2 || (fAbs <= this.f690b && fAbs2 <= this.f690b)) {
            return false;
        }
        if (fAbs >= fAbs2 * 0.5f || !this.r.b(i2)) {
            return (this.i[i] & i2) == 0 && fAbs > ((float) this.f690b);
        }
        int[] iArr = this.j;
        iArr[i] = iArr[i] | i2;
        return false;
    ...
    private boolean a(View view, float f, float f2) {
        ...
        return (z && z2) ? (f * f) + (f2 * f2) > ((float) (this.f690b * this.f690b)) : z ? Math.abs(f) > ((float) this.f690b) : z2 && Math.abs(f2) > ((float) this.f690b);
    }
