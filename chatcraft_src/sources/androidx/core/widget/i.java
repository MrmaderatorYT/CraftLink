...
public final class i {
    ...
    private static class a implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f686a;

        /* renamed from: b, reason: collision with root package name */
        private final TextView f687b;
        private Class c;
        private Method d;
        private boolean e;
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f686a.onCreateActionMode(actionMode, menu);
        }
        ...
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            a(menu);
            return this.f686a.onPrepareActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f686a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f686a.onDestroyActionMode(actionMode);
        }

        private void a(Menu menu) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            Context context = this.f687b.getContext();
            ...
            try {
                ...
                for (int i = 0; i < listA.size(); i++) {
                    ...
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(a(resolveInfo, this.f687b)).setShowAsAction(1);
                }
    ...
    public static b.a d(TextView textView) {
        if (Build.VERSION.SDK_INT >= 28) {
            return new b.a(textView.getTextMetricsParams());
        }
        b.a.C0037a c0037a = new b.a.C0037a(new TextPaint(textView.getPaint()));
        if (Build.VERSION.SDK_INT >= 23) {
            c0037a.a(textView.getBreakStrategy());
            c0037a.b(textView.getHyphenationFrequency());
        }
        if (Build.VERSION.SDK_INT >= 18) {
            c0037a.a(e(textView));
        }
