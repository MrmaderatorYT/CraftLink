...
final class d {
    static Shader a(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException {
        ...
        int iA = g.a(typedArrayA, xmlPullParser, "type", a.d.GradientColor_android_type, 0);
        ...
        switch (iA) {
            case 1:
                ...
                return new RadialGradient(fA5, fA6, fA7, aVarA.f535a, aVarA.f536b, a(iA2));
            case 2:
                return new SweepGradient(fA5, fA6, aVarA.f535a, aVarA.f536b);
            default:
                return new LinearGradient(fA, fA2, fA3, fA4, aVarA.f535a, aVarA.f536b, a(iA2));
        }
    }
    ...
    */
    ...
    static final class a {
        ...
        a(List<Integer> list, List<Float> list2) {
            int size = list.size();
            this.f535a = new int[size];
            this.f536b = new float[size];
            for (int i = 0; i < size; i++) {
                this.f535a[i] = list.get(i).intValue();
                this.f536b[i] = list2.get(i).floatValue();
            }
        }

        a(int i, int i2) {
            this.f535a = new int[]{i, i2};
            this.f536b = new float[]{0.0f, 1.0f};
        }

        a(int i, int i2, int i3) {
            this.f535a = new int[]{i, i2, i3};
            this.f536b = new float[]{0.0f, 0.5f, 1.0f};
        }
    }
}
