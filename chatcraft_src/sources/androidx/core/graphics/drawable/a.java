...
public final class a {
    ...
    private static Method f662a;

    /* renamed from: b, reason: collision with root package name */
    private static boolean f663b;
    ...
    public static boolean b(Drawable drawable, int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {
        ...
        if (!f663b) {
            try {
                f662a = Drawable.class.getDeclaredMethod("setLayoutDirection", Integer.TYPE);
        ...
        if (f662a != null) {
            try {
                f662a.invoke(drawable, Integer.valueOf(i));
                return true;
            } catch (Exception e2) {
