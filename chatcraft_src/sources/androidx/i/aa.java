...
class aa implements ac {
    ...
    aa(Context context, ViewGroup viewGroup, View view) {
        this.f799a = new a(context, viewGroup, view, this);
    }
    ...
    static class a extends ViewGroup {
        ...
        static {
            try {
                f800a = ViewGroup.class.getDeclaredMethod("invalidateChildInParentFast", Integer.TYPE, Integer.TYPE, Rect.class);
        ...
        public void a(View view) {
            if (view.getParent() instanceof ViewGroup) {
                ...
                if (viewGroup != this.f801b && viewGroup.getParent() != null && androidx.core.g.q.A(viewGroup)) {
                    int[] iArr = new int[2];
                    int[] iArr2 = new int[2];
                    viewGroup.getLocationOnScreen(iArr);
                    this.f801b.getLocationOnScreen(iArr2);
                    androidx.core.g.q.f(view, iArr[0] - iArr2[0]);
                    androidx.core.g.q.e(view, iArr[1] - iArr2[1]);
                }
        ...
        protected void dispatchDraw(Canvas canvas) {
            this.f801b.getLocationOnScreen(new int[2]);
        ...
        public ViewParent invalidateChildInParent(int[] iArr, Rect rect) {
            ...
            if (this.f801b instanceof ViewGroup) {
                iArr[0] = 0;
                iArr[1] = 0;
                int[] iArr2 = new int[2];
                a(iArr2);
