    ...
    public CardView(Context context, AttributeSet attributeSet, int i) throws Resources.NotFoundException {
        ...
        this.i = new d() { // from class: androidx.cardview.widget.CardView.1
            ...
            public void a(int i2, int i3) {
                if (i2 > CardView.this.f503a) {
                    CardView.super.setMinimumWidth(i2);
                }
                if (i3 > CardView.this.f504b) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.e.CardView, i, a.d.CardView);
        ...
        this.g = typedArrayObtainStyledAttributes.getBoolean(a.e.CardView_cardUseCompatPadding, false);
        this.h = typedArrayObtainStyledAttributes.getBoolean(a.e.CardView_cardPreventCornerOverlap, true);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.e.CardView_contentPadding, 0);
        this.c.left = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.e.CardView_contentPaddingLeft, dimensionPixelSize);
        this.c.top = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.e.CardView_contentPaddingTop, dimensionPixelSize);
        this.c.right = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.e.CardView_contentPaddingRight, dimensionPixelSize);
        this.c.bottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.e.CardView_contentPaddingBottom, dimensionPixelSize);
        float f2 = dimension2 > dimension3 ? dimension2 : dimension3;
        this.f503a = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.e.CardView_android_minWidth, 0);
        this.f504b = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.e.CardView_android_minHeight, 0);
