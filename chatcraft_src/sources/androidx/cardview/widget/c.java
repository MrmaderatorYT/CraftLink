...
class c implements e {
    ...
    @Override // androidx.cardview.widget.e
    public void a() {
        g.f512a = new g.a() { // from class: androidx.cardview.widget.c.1
            ...
            public void a(Canvas canvas, RectF rectF, float f, Paint paint) {
                ...
                if (f >= 1.0f) {
                    float f3 = f + 0.5f;
                    float f4 = -f3;
                    c.this.f508a.set(f4, f4, f3, f3);
                    int iSave = canvas.save();
                    canvas.translate(rectF.left + f3, rectF.top + f3);
                    canvas.drawArc(c.this.f508a, 180.0f, 90.0f, true, paint);
    ...
    public void a(d dVar, Context context, ColorStateList colorStateList, float f, float f2, float f3) {
        g gVarA = a(context, colorStateList, f, f2, f3);
        gVarA.a(dVar.b());
        dVar.a(gVarA);
        f(dVar);
    }
