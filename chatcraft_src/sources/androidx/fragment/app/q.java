...
public abstract class q {
    ...
    ArrayList<String> a(ArrayList<View> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            arrayList2.add(androidx.core.g.q.n(view));
            androidx.core.g.q.a(view, (String) null);
        }
        return arrayList2;
    }
    ...
    void a(View view, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String strN = androidx.core.g.q.n(view2);
            arrayList4.add(strN);
            if (strN != null) {
                androidx.core.g.q.a(view2, (String) null);
                ...
                while (true) {
                    ...
                    if (str.equals(arrayList3.get(i2))) {
                        androidx.core.g.q.a(arrayList2.get(i2), strN);
                        break;
                    }
                    i2++;
                }
        ...
        r.a(view, new Runnable() { // from class: androidx.fragment.app.q.1
            @Override // java.lang.Runnable
            public void run() {
                for (int i3 = 0; i3 < size; i3++) {
                    androidx.core.g.q.a((View) arrayList2.get(i3), (String) arrayList3.get(i3));
                    androidx.core.g.q.a((View) arrayList.get(i3), (String) arrayList4.get(i3));
                }
            }
        });
    }
    ...
    void a(ArrayList<View> arrayList, View view) {
        if (view.getVisibility() == 0) {
            if (view instanceof ViewGroup) {
                ...
                if (androidx.core.g.s.a(viewGroup)) {
    ...
    void a(View view, final ArrayList<View> arrayList, final Map<String, String> map) {
        r.a(view, new Runnable() { // from class: androidx.fragment.app.q.2
            @Override // java.lang.Runnable
            public void run() {
                int size = arrayList.size();
                for (int i = 0; i < size; i++) {
                    ...
                    String strN = androidx.core.g.q.n(view2);
                    if (strN != null) {
                        androidx.core.g.q.a(view2, q.a((Map<String, String>) map, strN));
                    }
                }
            }
        });
    ...
    void a(ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
        r.a(viewGroup, new Runnable() { // from class: androidx.fragment.app.q.3
            @Override // java.lang.Runnable
            public void run() {
                int size = arrayList.size();
                for (int i = 0; i < size; i++) {
                    View view = (View) arrayList.get(i);
                    androidx.core.g.q.a(view, (String) map.get(androidx.core.g.q.n(view)));
                }
            }
        });
    }
