...
public class ListMenuItemView extends LinearLayout implements AbsListView.SelectionBoundsAdjuster, p.a {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        as asVarA = as.a(getContext(), attributeSet, a.j.MenuView, i, 0);
        this.j = asVarA.a(a.j.MenuView_android_itemBackground);
        this.k = asVarA.g(a.j.MenuView_android_itemTextAppearance, -1);
        this.m = asVarA.a(a.j.MenuView_preserveIconSpacing, false);
        this.l = context;
        this.n = asVarA.a(a.j.MenuView_subMenuArrow);
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(null, new int[]{R.attr.divider}, a.C0018a.dropDownListViewStyle, 0);
    ...
    protected void onFinishInflate() {
        ...
        androidx.core.g.q.a(this, this.j);
    ...
    public void a(boolean z, char c) {
        int i = (z && this.f213a.f()) ? 0 : 8;
        if (i == 0) {
            this.f.setText(this.f213a.e());
        }
    ...
    public void setIcon(Drawable drawable) {
        boolean z = this.f213a.i() || this.r;
        if (z || this.m) {
            if (this.f214b == null && drawable == null && !this.m) {
                return;
            }
            if (this.f214b == null) {
                b();
    ...
    private void b() {
        this.f214b = (ImageView) getInflater().inflate(a.g.abc_list_menu_item_icon, (ViewGroup) this, false);
        a(this.f214b, 0);
    }
