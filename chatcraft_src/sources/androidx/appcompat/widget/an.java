...
class an {
    ...
    static final int[] f360a = {-16842910};

    /* renamed from: b, reason: collision with root package name */
    static final int[] f361b = {R.attr.state_focused};
    ...
    public static int a(Context context, int i2) {
        j[0] = i2;
        as asVarA = as.a(context, (AttributeSet) null, j);
        try {
            return asVarA.b(0, 0);
        } finally {
            asVarA.a();
    ...
    public static int c(Context context, int i2) {
        ...
        if (colorStateListB != null && colorStateListB.isStateful()) {
            return colorStateListB.getColorForState(f360a, colorStateListB.getDefaultColor());
        }
