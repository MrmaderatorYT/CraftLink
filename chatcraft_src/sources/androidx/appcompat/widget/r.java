...
class r {
    ...
    private static final int[] f426a = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* renamed from: b, reason: collision with root package name */
    private final ProgressBar f427b;
    private Bitmap c;

    r(ProgressBar progressBar) {
        this.f427b = progressBar;
    }

    void a(AttributeSet attributeSet, int i) {
        as asVarA = as.a(this.f427b.getContext(), attributeSet, f426a, i, 0);
        Drawable drawableB = asVarA.b(0);
        if (drawableB != null) {
            this.f427b.setIndeterminateDrawable(a(drawableB));
        }
        Drawable drawableB2 = asVarA.b(1);
        if (drawableB2 != null) {
            this.f427b.setProgressDrawable(a(drawableB2, false));
        }
        asVarA.a();
    }
