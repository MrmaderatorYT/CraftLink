...
class am extends androidx.c.a.c implements View.OnClickListener {
    ...
    public am(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
    ...
    private static final class a {
        ...
        public a(View view) {
            this.f358a = (TextView) view.findViewById(R.id.text1);
            this.f359b = (TextView) view.findViewById(R.id.text2);
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f359b != null) {
            ...
            if (TextUtils.isEmpty(charSequenceA)) {
                if (aVar.f358a != null) {
                    aVar.f358a.setSingleLine(false);
                    aVar.f358a.setMaxLines(2);
                }
            } else if (aVar.f358a != null) {
                aVar.f358a.setSingleLine(true);
                aVar.f358a.setMaxLines(1);
            }
            a(aVar.f359b, charSequenceA);
        }
        if (aVar.c != null) {
            a(aVar.c, e(cursor), 4);
        }
        ...
        if (this.q == 2 || (this.q == 1 && (i & 1) != 0)) {
            ...
            aVar.e.setTag(aVar.f358a.getText());
    ...
    private CharSequence b(CharSequence charSequence) {
        if (this.r == null) {
            ...
            this.d.getTheme().resolveAttribute(a.C0018a.textColorSearchUrl, typedValue, true);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (viewA != null) {
                ((a) viewA.getTag()).f358a.setText(e.toString());
            }
            return viewA;
        }
    }
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (viewB != null) {
                ((a) viewB.getTag()).f358a.setText(e.toString());
            }
            return viewB;
        }
    }
    ...
    private Drawable a(String str) throws NumberFormatException, IOException {
        ...
        try {
            ...
            Drawable drawableA = androidx.core.a.a.a(this.m, i);
            a(str2, drawableA);
            return drawableA;
