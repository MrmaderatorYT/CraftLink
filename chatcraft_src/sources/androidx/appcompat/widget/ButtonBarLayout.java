...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f279a = typedArrayObtainStyledAttributes.getBoolean(a.j.ButtonBarLayout_allowStacking, true);
    ...
    public void setAllowStacking(boolean z) {
        if (this.f279a != z) {
            this.f279a = z;
            if (!this.f279a && getOrientation() == 1) {
                setStacked(false);
            }
            requestLayout();
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (androidx.core.g.q.k(this) != paddingBottom) {
