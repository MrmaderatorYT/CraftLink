...
class AlertController {
    ...
    private final View.OnClickListener S = new View.OnClickListener() { // from class: androidx.appcompat.app.AlertController.1
        ...
        public void onClick(View view) {
            ...
            if (view == AlertController.this.c && AlertController.this.d != null) {
                messageObtain = Message.obtain(AlertController.this.d);
            ...
            AlertController.this.p.obtainMessage(1, AlertController.this.f89a).sendToTarget();
        }
    };
    ...
    private static final class b extends Handler {
        ...
        /* renamed from: a, reason: collision with root package name */
        private WeakReference<DialogInterface> f112a;

        public b(DialogInterface dialogInterface) {
            this.f112a = new WeakReference<>(dialogInterface);
        }
        ...
        public void handleMessage(Message message) {
            ...
            if (i != 1) {
                switch (i) {
                    ...
                    case -2:
                    case -1:
                        ((DialogInterface.OnClickListener) message.obj).onClick(this.f112a.get(), message.what);
                        break;
                }
            }
    ...
    public AlertController(Context context, g gVar, Window window) {
        ...
        this.r = window;
        this.p = new b(gVar);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, a.j.AlertDialog, a.C0018a.alertDialogStyle, 0);
    ...
    private void c() {
        ...
        if (z2 != 0) {
            ...
            View viewFindViewById10 = (this.u == null && this.f90b == null) ? null : viewGroupA.findViewById(a.f.titleDividerNoCustom);
        ...
        if (this.f90b instanceof RecycleListView) {
            ((RecycleListView) this.f90b).a(z2, z3);
        }
        if (!z) {
            View view = this.f90b != null ? this.f90b : this.i;
            if (view != null) {
                a(viewGroupA2, view, z2 | (z3 ? 2 : 0), 3);
            }
        }
        ListView listView = this.f90b;
    ...
    private void a(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        if (this.u != null) {
            ...
            if (this.f90b != null) {
                this.f90b.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: androidx.appcompat.app.AlertController.4
                ...
                this.f90b.post(new Runnable() { // from class: androidx.appcompat.app.AlertController.5
                    @Override // java.lang.Runnable
                    public void run() {
                        AlertController.a(AlertController.this.f90b, viewFindViewById, view2);
                    }
                });
                return;
            }
    ...
    private void a(ViewGroup viewGroup) {
        ...
        if (z) {
            ...
            if (this.f90b != null) {
                ((af.a) viewGroup.getLayoutParams()).g = 0.0f;
                return;
            }
            return;
        }
    ...
    private void c(ViewGroup viewGroup) {
        ...
        if (this.f90b != null) {
            ...
            viewGroup2.addView(this.f90b, iIndexOfChild, new ViewGroup.LayoutParams(-1, -1));
            return;
        }
        viewGroup.setVisibility(8);
    }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            this.f101b = typedArrayObtainStyledAttributes.getDimensionPixelOffset(a.j.RecycleListView_paddingBottomNoButtons, -1);
            this.f100a = typedArrayObtainStyledAttributes.getDimensionPixelOffset(a.j.RecycleListView_paddingTopNoTitle, -1);
        }
        ...
        public void a(boolean z, boolean z2) {
            ...
            setPadding(getPaddingLeft(), z ? getPaddingTop() : this.f100a, getPaddingRight(), z2 ? getPaddingBottom() : this.f101b);
        }
    }
    ...
    public static class a {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final LayoutInflater f103b;
        public Drawable d;
        ...
        public a(Context context) {
            this.f102a = context;
            this.f103b = (LayoutInflater) context.getSystemService("layout_inflater");
        }
        ...
        private void b(final AlertController alertController) {
            int i;
            ListAdapter cVar;
            final RecycleListView recycleListView = (RecycleListView) this.f103b.inflate(alertController.l, (ViewGroup) null);
            if (this.G) {
                if (this.K == null) {
                    cVar = new ArrayAdapter<CharSequence>(this.f102a, alertController.m, R.id.text1, this.v) { // from class: androidx.appcompat.app.AlertController.a.1
                    ...
                    cVar = new CursorAdapter(this.f102a, this.K, false) { // from class: androidx.appcompat.app.AlertController.a.2
                        private final int d;
                        private final int e;
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
                            return a.this.f103b.inflate(alertController.m, viewGroup, false);
                        }
                    };
                }
            } else {
                ...
                int i2 = i;
                if (this.K != null) {
                    cVar = new SimpleCursorAdapter(this.f102a, i2, this.K, new String[]{this.L}, new int[]{R.id.text1});
                } else if (this.w != null) {
                    cVar = this.w;
                } else {
                    cVar = new c(this.f102a, i2, R.id.text1, this.v);
                }
            }
            if (this.O != null) {
            ...
            if (this.x != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.a.3
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i3, long j) {
                        a.this.x.onClick(alertController.f89a, i3);
                        if (a.this.H) {
                            return;
                        }
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.a.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i3, long j) {
                        ...
                        a.this.J.onClick(alertController.f89a, i3, recycleListView.isItemChecked(i3));
                    }
                });
            }
            if (this.N != null) {
            ...
            alertController.f90b = recycleListView;
        }
    }
