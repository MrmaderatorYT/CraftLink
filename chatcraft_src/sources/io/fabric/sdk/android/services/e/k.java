...
class k implements v {
    ...
    public t a(io.fabric.sdk.android.services.b.k kVar, JSONObject jSONObject) {
        int iOptInt = jSONObject.optInt("settings_version", 0);
        int iOptInt2 = jSONObject.optInt("cache_duration", 3600);
        return new t(a(kVar, iOptInt2, jSONObject), a(jSONObject.getJSONObject("app")), e(jSONObject.getJSONObject("session")), f(jSONObject.getJSONObject("prompt")), c(jSONObject.getJSONObject("features")), d(jSONObject.getJSONObject("analytics")), g(jSONObject.getJSONObject("beta")), iOptInt, iOptInt2);
    }

    private e a(JSONObject jSONObject) {
        return new e(jSONObject.getString("identifier"), jSONObject.getString("status"), jSONObject.getString("url"), jSONObject.getString("reports_url"), jSONObject.getString("ndk_reports_url"), jSONObject.optBoolean("update_required", false), (jSONObject.has("icon") && jSONObject.getJSONObject("icon").has("hash")) ? b(jSONObject.getJSONObject("icon")) : null);
    }
    ...
    private f g(JSONObject jSONObject) {
        return new f(jSONObject.optString("update_endpoint", u.f4321a), jSONObject.optInt("update_suspend_duration", 3600));
    }

    private long a(io.fabric.sdk.android.services.b.k kVar, long j, JSONObject jSONObject) {
