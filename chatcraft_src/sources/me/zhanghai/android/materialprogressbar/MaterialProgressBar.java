...
public class MaterialProgressBar extends ProgressBar {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        as asVarA = as.a(context, attributeSet, R.styleable.MaterialProgressBar, i, i2);
        this.mProgressStyle = asVarA.a(R.styleable.MaterialProgressBar_mpb_progressStyle, 0);
        boolean zA = asVarA.a(R.styleable.MaterialProgressBar_mpb_setBothDrawables, false);
        boolean zA2 = asVarA.a(R.styleable.MaterialProgressBar_mpb_useIntrinsicPadding, true);
        boolean zA3 = asVarA.a(R.styleable.MaterialProgressBar_mpb_showProgressBackground, this.mProgressStyle == 1);
        int iA = asVarA.a(R.styleable.MaterialProgressBar_mpb_determinateCircularProgressStyle, 0);
        if (asVarA.g(R.styleable.MaterialProgressBar_mpb_progressTint)) {
            this.mProgressTintInfo.mProgressTint = asVarA.e(R.styleable.MaterialProgressBar_mpb_progressTint);
            this.mProgressTintInfo.mHasProgressTint = true;
        }
        if (asVarA.g(R.styleable.MaterialProgressBar_mpb_progressTintMode)) {
            this.mProgressTintInfo.mProgressTintMode = DrawableCompat.parseTintMode(asVarA.a(R.styleable.MaterialProgressBar_mpb_progressTintMode, -1), null);
            this.mProgressTintInfo.mHasProgressTintMode = true;
        }
        if (asVarA.g(R.styleable.MaterialProgressBar_mpb_secondaryProgressTint)) {
            this.mProgressTintInfo.mSecondaryProgressTint = asVarA.e(R.styleable.MaterialProgressBar_mpb_secondaryProgressTint);
            this.mProgressTintInfo.mHasSecondaryProgressTint = true;
        }
        if (asVarA.g(R.styleable.MaterialProgressBar_mpb_secondaryProgressTintMode)) {
            this.mProgressTintInfo.mSecondaryProgressTintMode = DrawableCompat.parseTintMode(asVarA.a(R.styleable.MaterialProgressBar_mpb_secondaryProgressTintMode, -1), null);
            this.mProgressTintInfo.mHasSecondaryProgressTintMode = true;
        }
        if (asVarA.g(R.styleable.MaterialProgressBar_mpb_progressBackgroundTint)) {
            this.mProgressTintInfo.mProgressBackgroundTint = asVarA.e(R.styleable.MaterialProgressBar_mpb_progressBackgroundTint);
            this.mProgressTintInfo.mHasProgressBackgroundTint = true;
        }
        if (asVarA.g(R.styleable.MaterialProgressBar_mpb_progressBackgroundTintMode)) {
            this.mProgressTintInfo.mProgressBackgroundTintMode = DrawableCompat.parseTintMode(asVarA.a(R.styleable.MaterialProgressBar_mpb_progressBackgroundTintMode, -1), null);
            this.mProgressTintInfo.mHasProgressBackgroundTintMode = true;
        }
        if (asVarA.g(R.styleable.MaterialProgressBar_mpb_indeterminateTint)) {
            this.mProgressTintInfo.mIndeterminateTint = asVarA.e(R.styleable.MaterialProgressBar_mpb_indeterminateTint);
            this.mProgressTintInfo.mHasIndeterminateTint = true;
        }
        if (asVarA.g(R.styleable.MaterialProgressBar_mpb_indeterminateTintMode)) {
            this.mProgressTintInfo.mIndeterminateTintMode = DrawableCompat.parseTintMode(asVarA.a(R.styleable.MaterialProgressBar_mpb_indeterminateTintMode, -1), null);
        ...
        switch (this.mProgressStyle) {
            case 0:
                ...
                if (!isIndeterminate() || zA) {
                    setProgressDrawable(new CircularProgressDrawable(iA, context));
                    break;
                }
                break;
            case 1:
