    ...
    protected final String escapeSlow(String str, int i) {
        ...
        while (i < length) {
            ...
            if (cArrEscape != null) {
                ...
                if (i4 > 0) {
                    str.getChars(i3, i, cArrGrowBuffer, length2);
                    length2 = i5;
                }
            ...
            i3 = (Character.isSupplementaryCodePoint(iCodePointAt) ? 2 : 1) + i;
            i = nextEscapeIndex(str, i3, length);
        }
        int i6 = length - i3;
        if (i6 > 0) {
            i2 = i6 + length2;
            if (cArrGrowBuffer.length < i2) {
                cArrGrowBuffer = growBuffer(cArrGrowBuffer, length2, i2);
            }
            str.getChars(i3, length, cArrGrowBuffer, length2);
        } else {
            i2 = length2;
        }
