...
import com.github.steveice10.mc.v1_7_7.protocol.data.message.TextMessage;
...
public class PacketHandler_v1_7_7 extends BasePacketHandler {
    private double x;
    private double y;
    private double z;

    public PacketHandler_v1_7_7(a aVar, b bVar) {
        super(aVar, bVar);
        this.x = -1.0d;
        this.y = -1.0d;
        this.z = -1.0d;
