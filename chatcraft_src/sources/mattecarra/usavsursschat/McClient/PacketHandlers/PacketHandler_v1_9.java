...
import com.github.steveice10.mc.v1_9.protocol.data.game.ClientRequest;
import com.github.steveice10.mc.v1_9.protocol.data.game.PlayerListEntry;
import com.github.steveice10.mc.v1_9.protocol.data.game.PlayerListEntryAction;
...
public class PacketHandler_v1_9 extends BasePacketHandler {
    private double x;
    private double y;
    private double z;

    public PacketHandler_v1_9(a aVar, b bVar) {
        super(aVar, bVar);
        this.x = -1.0d;
        this.y = -1.0d;
        this.z = -1.0d;
