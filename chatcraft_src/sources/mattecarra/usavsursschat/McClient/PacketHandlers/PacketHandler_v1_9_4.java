...
import com.github.steveice10.mc.v1_9_4.protocol.data.game.ClientRequest;
import com.github.steveice10.mc.v1_9_4.protocol.data.game.PlayerListEntry;
import com.github.steveice10.mc.v1_9_4.protocol.data.game.PlayerListEntryAction;
...
public class PacketHandler_v1_9_4 extends BasePacketHandler {
    private double x;
    private double y;
    private double z;

    public PacketHandler_v1_9_4(a aVar, b bVar) {
        super(aVar, bVar);
        this.x = -1.0d;
        this.y = -1.0d;
        this.z = -1.0d;
    ...
    public void senTabCompletePacket(String str) {
        this.mc_client.d().getSession().send(new ClientTabCompletePacket(str, false));
    }
